package com.ccs.api.exceptionhandler.model;
...
@Schema(name = "ExceptionResponse",
        description = "Representa exceções da api, implementação da \"rfc7807\" Problem Details for HTTP APIs ",
        externalDocs = @ExternalDocumentation(description = "Problem Details for HTTP APIs", url = "https://datatracker.ietf.org/doc/html/rfc7807"))
